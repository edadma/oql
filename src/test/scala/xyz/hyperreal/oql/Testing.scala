  ...
  val employeesDB =
    new RDBConnection(
      """
        ...
        |
        |employee
        | emp_id: integer, pk  emp_name: text  job_name: text  manager_id: integer, fk, employee, emp_id  hire_date: date  salary: currency  commission: text  dep_id: integer, fk, department, dep_id 
